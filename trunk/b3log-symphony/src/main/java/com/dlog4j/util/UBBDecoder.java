...
public class UBBDecoder {
    ...
    private static String decode(String s, UBBTagHandler th, int mode,
        ...
        return show.replaceAll("\\[em:(.+?)\\]",
                               "<img src='/image/emote/em$1.gif' style=\"border:0\">");
    }
        ...
        if ("b".equals(tmp) || "i".equals(tmp) || "u".equals(tmp)) {
            ...
            if (code.equals("#") == true) {
                ...
                if (domain.equals("moabc")) {
                    return "<a href='" + link + "' target=_blank>" + data
                           + "</a>";
                } else {
